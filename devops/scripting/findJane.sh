...
files=$(grep " jane " /home/student-02-76d3467c8ac2/data/list.txt | cut -d ' ' -f 3)

for file in $files; do
  echo $file
  if test -e /home/student-02-76d3467c8ac2$file; then echo  /home/student-02-76d3467c8ac2$file >> oldFiles.txt;fi
done
